...
public class Report extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //add the tabs
        mTabLayout.addTab(mTabLayout.newTab().setText("POLLUTION"));
        mTabLayout.addTab(mTabLayout.newTab().setText("ENCROACHMENT"));
        mTabLayout.addTab(mTabLayout.newTab().setText("RRR"));
